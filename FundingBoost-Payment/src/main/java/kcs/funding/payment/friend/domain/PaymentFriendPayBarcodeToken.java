...
public class PaymentFriendPayBarcodeToken extends BaseTimeEntity {
    ...
    private PaymentFriendPayBarcodeTokenStatus tokenStatus;
    ...
    public static PaymentFriendPayBarcodeToken createToken(
            String barcodeToken,
        ...
        PaymentFriendPayBarcodeToken token = new PaymentFriendPayBarcodeToken();
        token.barcodeToken = barcodeToken;
        token.member = member;
        token.funding = funding;
        token.usingPoint = usingPoint;
        token.fundingPrice = fundingPrice;
        token.tokenStatus = PaymentFriendPayBarcodeTokenStatus.PENDING;
    ...
    public void markUsed(LocalDateTime now) {
        this.tokenStatus = PaymentFriendPayBarcodeTokenStatus.USED;
        this.usedAt = now;
    }

    public void markExpired() {
        if (this.tokenStatus == PaymentFriendPayBarcodeTokenStatus.PENDING) {
            this.tokenStatus = PaymentFriendPayBarcodeTokenStatus.EXPIRED;
        }
    }
}

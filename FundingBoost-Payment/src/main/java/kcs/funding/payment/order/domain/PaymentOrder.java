...
public class PaymentOrder extends BaseTimeEntity {
    ...
    public static PaymentOrder createOrder(PaymentMember member, PaymentDelivery delivery) {
    ...
    public void applyPaymentBreakdown(int pointUsedAmount, int directPaidAmount, int fundingSupportedAmount, Long sourceFundingId) {
